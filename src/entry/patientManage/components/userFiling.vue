<template>
  <div style="background-color: #eff7fd;height: 100%;overflow-x: hidden;">
    ...
    <div class="weui-cells-wzl weui-cells_form">
      ...
      <div class="wzl-local">
        <div
          class="weui-cells__title wzl"
          style="font-size: 18px;margin-top:0.5em;margin-bottom: 0.2em;color:black;"
        >您的性别</div>
            ...
            <div class="weui-cells-wzl weui-cells_radio">
              <label
                ...
                style="width: unset;background-color: white;
                      ...
                      border-top: inset;border-top: #d5ebf9;border-top-width: thin;border-radius: 5px;"
                for="x11"
              >
                <div class="weui-cell__bd">
                  <p>男</p>
      ...
      <div class="wzl-local">
        <div
          class="weui-cells__title wzl"
          style="margin-top: 0.5em;font-size: 18px;margin-bottom: 0.2em;color:black;"
        >出生日期</div>
      ...
      <div class="wzl-local">
        ...
        <div
          class="weui-cell-wzl"
          style="margin-top: 0px;padding-bottom:0px;padding-top:0px;border-bottom-color:#d5ebf9"
        >
          <div class="weui-cell__bd">
            <input
              v-model="lxdh"
      ...
      <div style="margin-top: 10px;margin-bottom: 30px;">
        <div>
          <a href="javascript:;" class="weui-btn weui-btn_primary" v-on:click="toindex()">返回</a>
        </div>
      </div>
    </div>
  </div>
