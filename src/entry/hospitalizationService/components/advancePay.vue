  ...
  <div style="overflow: auto;height: 100%;">
    <div class="ad-header">
      <div class="ad-headerImg">
        <img
          src="../../../../static/img/头像1.png"
          style="width: 6%;position: absolute;top: 18px;
    left: 17px;"
        />
      </div>
      <div class="ad-title">
    ...
    <div class="ad-select">
      <div
        class="weui-row"
        style="height: 60px;width: calc(100vw - 20px);margin-left: auto;margin-right: auto;"
      >
        <div class="weui-col-25">
          <a href="javascript:;" class="weui-btn weui-btn_primary" @click="selectMoney(500)">500</a>
        </div>
        <div class="weui-col-25">
          <a href="javascript:;" class="weui-btn weui-btn_primary" @click="selectMoney(1000)">1000</a>
        </div>
        <div class="weui-col-25">
          <a href="javascript:;" class="weui-btn weui-btn_primary" @click="selectMoney(1500)">1500</a>
        </div>
        <div class="weui-col-25">
          <a href="javascript:;" class="weui-btn weui-btn_primary" @click="selectMoney(2000)">2000</a>
        </div>
      </div>
          ...
          self.model.placeOrderByWN(data).then(function(res) {
            if (res.data.code == 0) {
              if (process.env.NODE_ENV == "dev") {
                window.location =
                  "../pay.html?appId=" +
                  self.getAesString(res.data.data.appId) +
                  "&timeStamp=" +
                  self.getAesString(res.data.data.timeStamp) +
                  "&nonceStr=" +
                  self.getAesString(res.data.data.nonceStr) +
                  "&pack=" +
                  self.getAesString(res.data.data.package) +
                  "&paySign=" +
                  self.getAesString(res.data.data.paySign) +
                  "&action=gh";
