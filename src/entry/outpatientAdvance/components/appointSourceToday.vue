      ...
      <div class="weui-panel__bd">
        <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
          ...
          <div class="weui-media-box__bd">
            <h4 class="weui-media-box__title" style="float: left;">标题一</h4>
            ...
            <h4 class="weui-media-box__title">挂号费用: ¥25元</h4>
        ...
        <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
          ...
          <div class="weui-media-box__bd">
            ...
            <h4 class="weui-media-box__title">职位: 主治医师</h4>
            <h4 class="weui-media-box__title">挂号费用: ¥25元</h4>
            <div class="hero-button">
              <el-button type="primary" round>预约</el-button>
            </div>
...
export default {
  ...
  methods: {
    ...
    search() {
      let self = this;
      var ksdm = this.GetQueryString('ksdm');
      var czlx = self.GetQueryString("czlx");
      console.log(window.location.hash.substr(26));
      let data = {
        ksdm:ksdm
      }

      this.model.getDepartmentNumberSource(data).then(function(res){
        if(res.data.code == '0'){
