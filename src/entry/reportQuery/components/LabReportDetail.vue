  ...
  <div style="height: 100%;background-color: #EFF7FD;">
    ...
    <div class="r-content">
      <div class="r-content-item" v-for="item in detailr">
        ...
        <div class="hero-list-item">
          <div class="hero-list-item-left">
            <p class="weui-media-box__desc">检验结果</p>
          </div>
          <!--<div class="hero-list-item-right" style="margin-left: 37px;">
        ...
        <div class="item-content">
          <el-input type="textarea" autosize v-model="item.jyjg"></el-input>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getDetail() {
      ...
      this.applyTime = this.insertStr(
        this.insertStr(
          this.insertStr(
            this.insertStr(this.insertStr(time, 4, "/"), 7, "/"),
            10,
            "  "
          ),
          14,
