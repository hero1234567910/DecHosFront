<template>
  <div
    ...
    style="height: 100%;background-color: #EFF7FD;overflow: auto;"
  >
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <div class="card-hero">
          <img
            src="../../../../static/img/项目大.png"
            style="position: absolute;top: -2px;width: 70%;"
          />
        </div>
      ...
      <div class="weui-cell">
        ...
        <div class="weui-cell__ft">{{doctors}}</div>
      </div>
      ...
      <div class="weui-cell">
        ...
        <div class="weui-cell__ft">{{groupconclusion}}</div>
      </div>
    </el-card>
    ...
    <div class="weui-panel weui-panel_access" style="margin-top: 0px;">
      <div class="weui-panel__hd" style="background-color: #EFF7FD;line-height: 38px;">
        <div class="img-panel">
          <img
            src="../../../../static/img/疾病及处理建议.png"
            style="position: absolute;top: 8px;width: 45%;"
          />
        </div>检查项目
      </div>
      <div class="weui-panel__bd">
        <div class="weui-media-box__bd">
          <div class="weui-cell" v-for="item in ItemDetails">
            ...
            <div
              class="weui-cell__ft"
            >{{item.positive==1?'阳性':'阴性'}} {{item.itemresult}}{{item.itemunit}}</div>
          </div>
